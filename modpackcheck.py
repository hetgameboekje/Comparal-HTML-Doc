...
document1_li = {}
document2_li = {}
document1 = input("What is the filename in this folder for the upcoming version? \n")
document2 = input("What is the filename in this folder for the previous version? \n")
...
process_html_file(document1+".html", document1_li)

# Process the second HTML document
process_html_file(document2+".html", document2_li)
